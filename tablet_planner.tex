...
\foreach \x/\day in {0/月,1/火,2/水,3/木,4/金,5/土,6/日} {
  ...
  \fill[lightgray] (\xpos mm,380mm) rectangle (\xposend mm,396mm);
  \draw[thick] (\xpos mm,380mm) rectangle (\xposend mm,396mm);
  \pgfmathsetmacro{\xcenter}{\xpos+17.285}
  \node[font=\fontsize{18}{22}\selectfont\bfseries] at (\xcenter mm,388mm) {\day};
}
...
\foreach \x in {0,1,...,7} {
  \pgfmathsetmacro{\xpos}{10+\x*34.57}
  \draw[thick] (\xpos mm,0mm) -- (\xpos mm,396mm);
}
...
\foreach \h in {6,7,...,23} {
  ...
  \node[anchor=east,font=\fontsize{14}{16}\selectfont] at (23mm,\ycenter mm) {\h:00};
  \draw[thick] (25mm,\y mm) -- (25mm,\yend mm);
}
...
\foreach \i in {1,2,...,12} {
  ...
  \node[anchor=west,font=\fontsize{12}{14}\selectfont] at (139mm,\ycenter mm) {$\square$};
}
...
\foreach \x/\day in {0/日,1/月,2/火,3/水,4/木,5/金,6/土} {
  ...
  \pgfmathsetmacro{\xposend}{10+(\x+1)*34.57}
  \pgfmathsetmacro{\xcenter}{\xpos+17.285}
  \fill[lightgray] (\xpos mm,377mm) rectangle (\xposend mm,398mm);
  \draw[thick] (\xpos mm,377mm) rectangle (\xposend mm,398mm);
  \node[font=\fontsize{16}{20}\selectfont\bfseries] at (\xcenter mm,387.5mm) {\day};
}
...
\foreach \row in {0,1,...,5} {
  \foreach \col in {0,1,...,6} {
    ...
    \draw[thick] (\xpos mm,\y mm) rectangle (\xposend mm,\yend mm);
  }
}
\end{tikzpicture}
